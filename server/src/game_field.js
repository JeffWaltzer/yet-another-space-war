...
var GameField = meta.objectify(function(initial_state) {
...
GameField.method('field_size',
		 function () {
		     return this._field_size;
		 });

GameField.method('screen_objects',
		 function(new_value) {
		     if (new_value)
...
GameField.method('each_screen_object',
		 function(callback_function) {
		     return underscore.map(this.screen_objects(), callback_function);
		 });

GameField.method('collisions_with',
		 function(screenObject,start_index) {
		     var to_remove = [];
...
GameField.method('remove_dead_objects',
		 function() {
		     this.screen_objects(
...
GameField.method('update_screen_objects',
		 function(tick_rate, ship_rotation_rate, acceleration_rate) {
...
GameField.method('remove_screen_objects',
		 function(to_remove) {
...
GameField.method('remove_screen_object',
		 function(to_remove) {
...
GameField.method('maybe_explode',
		 function(screen_object, o) {
		     screen_object.explode();
		     o.explode();
		 });


GameField.method('maybe_bump_score',
		 function(screen_object, o) {
...
GameField.method('handle_collisions',
		 function() {

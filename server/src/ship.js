...
var Ship= meta.objectify(function(initial_state) {
...
Ship.method('update', function(tick_rate, rotation_rate, acceleration_rate) {
    var self = this;
...
Ship.method('gun_point', function() {
    var self = this;
...
Ship.method('clone', function() {this.game.add_ship();});

Ship.method('is_ship', function() {return true;});

Ship.method('score', function() {
    if (!this.player())
	return null;

...
var ScreenObject = meta.objectify(function(initial_state) {
...
ScreenObject.method('ignores_collisions', function() { return false; });
...
ScreenObject.method('is_bullet', function () { return false; });

ScreenObject.method('is_fragment', function () { return false; });

ScreenObject.method('is_ship', function () { return false; });

ScreenObject.method('outline', function() { return this.outline_cache; });
...
ScreenObject.method('live', function() { return true; });

ScreenObject.method('score', function() { return 0; });
...
ScreenObject.method('explode', function() {});
